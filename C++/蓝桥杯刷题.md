...
bool compareChars(const char& a, const char& b) {return a < b;}

**sort**(name.begin(), name.end(), compareChars);从小到大排序



// 先提供自定义比较函数
bool caseSensitiveCompare(const string& a, const string& b) {return a < b;}

sort(strings.begin(), strings.end(), caseSensitiveCompare);

for (const auto& str : strings) {cout << str;}

//忽略大小写
bool caseInsensitiveCompare(const std::string& a, const string& b) {
...
比较浮点数： fabs(res - 11625907.5798) < 0.0001 判断浮点数相同用差<0.01
